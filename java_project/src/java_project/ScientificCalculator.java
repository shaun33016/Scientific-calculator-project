...
class ScientificCalculator 
{
	...
	private void initialize() 
	{
		...
		frmCalculator.getContentPane().setBackground(new Color(237, 237, 237));
		...
		butttonPanel.setOpaque(false);
		butttonPanel.setBorder(null);
		...
		butttonPanel.setBorder(BorderFactory.createEmptyBorder());
	    textPanel.setBorder(BorderFactory.createEmptyBorder());
	    butttonPanel.setLayout(new GridLayout(6, 5, 4, 4));
		Border roundedBorder = BorderFactory.createLineBorder(new Color(150, 150, 150), 5, true);
		...
		button1.setBackground(new Color(70, 70, 180));
		...
		button2.setBackground(new Color(180, 70, 70));
		...
		button4.setBackground(new Color(150, 150, 150));
		...
		button5.setBackground(new Color(150, 150, 150));
		button5.setFont(new Font("Calibri Light", Font.PLAIN, 17));
		butttonPanel.add(button5);
		...
		button6.setBackground(new Color(150, 150, 150));
		...
		button7.setBackground(new Color(150, 150, 150));
		...
		button8.setBackground(new Color(150, 150, 150));
		...
		button9.setBackground(new Color(150, 150, 150));
		...
		button10.setBackground(new Color(150, 150, 150));
		...
		button11.setBackground(new Color(150, 150, 150));
		...
		button15.setBackground(new Color(150, 150, 150));
		...
		button16.setBackground(new Color(150, 150, 150));
		...
		button20.setBackground(new Color(150, 150, 150));
		...
		button21.setBackground(new Color(150, 150, 150));
		...
		button25.setBackground(new Color(150, 150, 150));
		...
		button26.setBackground(new Color(150, 150, 150));
		...
		button27.setBackground(new Color(150, 150, 150));
		...
		button30.setBackground(new Color(150, 150, 150));
